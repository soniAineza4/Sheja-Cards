        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          >
            <Link
              ...
              className="flex items-center space-x-2"
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-200/10">
                <IconInnerShadowTop className="h-5 w-5 text-white" />
              </div>
          ...
          <div className="hidden items-center space-x-4 lg:flex">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                prefetch={false}
                href="/auth/signup"
                className="inline-flex items-center space-x-2 rounded-full bg-white/80 px-6 py-2.5 font-medium text-black transition-all duration-200 hover:shadow-lg"
              >
              ...
              <div className="border-border bg-background/95 mt-4 space-y-2 rounded-xl border py-4 shadow-xl backdrop-blur-lg">
                ...
                <div className="space-y-2 px-4 py-2">
                  ...
                  <Link
                    prefetch={false}
                    href="/auth/signup"
                    className="block w-full rounded-lg bg-gray-400 py-2.5 text-center font-medium text-white transition-all duration-200 hover:shadow-lg"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Get Started
                  </Link>
