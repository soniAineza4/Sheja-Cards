...
export default function Hero() {
  return (
    <div className="bg-background relative w-full overflow-hidden" id="hero">
      {/* Background gradient */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            Run Your School Smarter, Faster, Better
          </motion.h1>
          ...
          >
            A modern student card management platform that helps schools run
            effortlessly, responsive, and built to simplify everything from
            enrollment to analytics.
          </motion.p>
